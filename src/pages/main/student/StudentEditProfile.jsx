        ...
        <div className="flex items-center justify-center h-5/6  bg-gradient-to-r from-blue-500 to-purple-500">
            <div className='flex justify-center items-center flex-col w-4/5'>
                ...
                <div className="  p-4  w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  rounded-md  ">
                    ...
                    <div className="m-4  text-white lg:mx-8 border-2 rounded-md p-4 bg-blue-400 hover:bg-blue-500 ">
                    ...
                    <div className="m-4 lg:mx-8 border-2 rounded-md p-4 bg-blue-400 hover:bg-blue-500 ">
